...
# Clustering logic：
# 1. Data Analyst: Include both ‘data’ and ‘analyst’
# 2. Data Scientist: contains only ‘data’
# 3. Business Analyst: contains only ‘analyst’
# 4. Other: does not contain ‘data’ or ‘analyst’
def categorize_job(title):
    title_lower = title.lower()
    contains_data = "data" in title_lower
    contains_analyst = "analyst" in title_lower

    if contains_data and contains_analyst:
        return "Data Analyst"
    elif contains_data:
        return "Data Scientist"
    elif contains_analyst:
